...
import 'simple_grpc.pb.dart' as $0;
export 'simple_grpc.pb.dart';

class SimpleGrpcClient extends $grpc.Client {
  static final _$getFeature = $grpc.ClientMethod<$0.Point, $0.Feature>(
      '/simplegrpc.SimpleGrpc/GetFeature',
...
abstract class SimpleGrpcServiceBase extends $grpc.Service {
  $core.String get $name => 'simplegrpc.SimpleGrpc';

  SimpleGrpcServiceBase() {
